...
| Nominal Capacity | The initial capacity of the battery defined in the test object. |

# Applications

| Application | Description |
| Evaluating degradation | Under real-world charging patterns (like EVs charging overnight). |
| Accelerated aging tests | Where cycle time must remain fixed to analyze time-based degradation factors. |
...
| --- | --- | --- | --- |
| Cycle time | (Charge Capacity + Discharge Capacity)/Current | Formula for calculating cycle time | |
