...
|------|------|------|
| Default testing temperature | 30 | °C |

# Industry Context

| Factor | Description |
|------|------|
| EV battery testing | Requires specialized equipment and conditions |
...
* Arbin’s MZTC battery test chamber is designed for temperature stability.
* The Arbin tester can be controlled in real-time via CAN Bus.
* Auxiliary inputs allow for monitoring of individual cell voltage and temperature.
