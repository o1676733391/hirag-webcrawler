...
|------|------|------|
| Number of users for notifications | Up to 3 | Registered to receive email or SMS notifications |

# Industry Context

| Factor | Description |
|------|------|
| Testing efficiency | In-person management of multiple cyclers is inefficient and impractical. |
| Safety management | Individual management of battery testers can lead to delays in addressing potential hazards. |

# Related Technologies / Concepts

| Concept | Description |
|------|------|
| Central Monitor and Control Solution (CMCS) | A solution for managing multiple Arbin cyclers efficiently. |
| ArbinViewer | A tool for oversight and control of networked cyclers. |
| CTI Interface | Allows third-party management of battery testers. |

# Notes

* CMCS is just one part of Arbin’s full battery testing solution, which includes Arbin battery test equipment, auxiliary test equipment options, software, and several layers of data management solutions to address your next battery testing challenge.
* For those who want more security and accessibility for battery testing data, Arbin’s Central Data Solution allows you to backup data to a central network or cloud-based server.
