...
- URL: https://www.arbin.com/batteries-for-flying-cars-evtols.html

# Content

#  Where Are The Flying Cars
July 24, 2019
![](https://www.arbin.com/wp-content/uploads/2019/07/jetsons-300x200-3.png)
**Introduction
...
** Developing the right battery is still the key to creating a flying vehicle that can be clean, green, and efficient. Battery testing must also catch up with the needs of battery and vehicle developers to better understand what can be done to make them better. [[Battery testing equipment]](https://www.arbin.com/products/battery-test-equipment/) should be able to detect the smallest changes in the battery early in the testing phase so researches can quickly pick out factors that affect battery health. Equipment like Arbin’s cuts through the measurement noise present in lower quality equipment, allowing researchers to see minute changes and trends. Thus, more effectively assessing and predicting the efficiency and health of the battery.
Temperature control equipment like [[Arbin’s MZTC Multi-Chamber]](https://www.arbin.com/products/chambers-and-other-products/battery-test-chamber/), also helps ensure superior measurement precision and safety during testing. Accelerating the [[testing and development process]](https://www.arbin.com/battery-test-applications-electric-vehicle/) by reducing the chances of one battery cell affecting the other and causing issues like cascade failures. With flying car batteries, where heat and temperature control is crucial, having the right battery testing equipment is critical.
...
Posts navigation
[← Drones are flying further thanks to battery test equipment](https://www.arbin.com/drones-are-flying-further-thanks-to-battery-test-equipment.html)
