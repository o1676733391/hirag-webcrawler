...
- URL: https://www.arbin.com/safe-testing-for-ev-batteries.html

# Content

#  Safe Testing for EV Batteries
September 12, 2019
**Why[researching Electric Vehicles](https://www.arbin.com/battery-test-equipment/electric-vehicle-battery-testing.html) batteries has never been safer**
Advancement in battery testing equipment has made the process of battery testing safer. With more precise and accurate testing equipment, the smallest changes in a battery can be detected before it becomes a critical issue. Improved equipment also allows for a more stable and controlled testing environment, making the [research and development process](https://www.arbin.com/battery-test-applications-electric-vehicle/) much more efficient.
...
![Multi-Zone Temperature Chamber showing inside of chamber](https://www.arbin.com/wp-content/uploads/2019/09/MTZC-Mini-Chamber.png)Arbin Battery Test Chamber.
[Arbin’s multi-chamber equipment ](https://www.arbin.com/products/chambers-and-other-products/battery-test-chamber/)isolates each battery cell or pairs of cells during testing, creating a safer and contained test environment that maintains temperature stability. Each chamber is thermally isolated and can have its own unique temperature set point so as to keep batteries from affecting each other during testing. This is a safer and more accurate testing method to see how temperature affects batteries.
**Conclusion**
...
Posts navigation
[← Batteries in Space](https://www.arbin.com/batteries-in-space.html)
[Lightsaber Battery Analysis →](https://www.arbin.com/lightsaber-battery-analysis.html)
