...
### SDL-Disable
![ARBIN-ACL-SDL-Disable](https://www.arbin.com/wp-content/uploads/v2/ss-smart-data-logging/ARBIN-ACL-SDL-Disable.png)
### SDL-Enable
![ARBIN-ACL-SDL-Enable](https://www.arbin.com/wp-content/uploads/v2/ss-smart-data-logging/ARBIN-ACL-SDL-Enable.png)
...
![](https://www.arbin.com/wp-content/uploads/2024/10/Arbin-SD-Logging-Solution-method-1-i1.png)
...
![](https://www.arbin.com/wp-content/uploads/2024/10/Arbin-SD-Logging-Solution-method-1-i2.png)
Figure 3. Testing Schedule for Regular Data Logging 
![](https://www.arbin.com/wp-content/uploads/2024/10/Arbin-SD-Logging-Solution-method-1-i3.png)
...
![](https://www.arbin.com/wp-content/uploads/2024/10/Arbin-SD-Logging-Solution-method-1-i4.png)
Figure 5. Testing Schedule for Smart Data Logging (Mits Pro8) 
METHOD1. Applying SDL with Arbin Cyclers using MITS 
Smart Data Logging
Charging the battery to 3.8V using 1A current and log data when ∆V > 5mV or every 5 minutes. 
![](https://www.arbin.com/wp-content/uploads/2024/10/Arbin-SD-Logging-Solution-method-1-i5.png)
Figure 6. Testing Schedule for Smart Data Logging (MITS) 
![](https://www.arbin.com/wp-content/uploads/2024/10/Arbin-SD-Logging-Solution-method-1-i6.png)
...
```html
<div class="frame-flex-table">
        <div class="frame-1">
          <div class="method-1-applying-sdl-with-arbin-cyclers-using-mits-pro-8">
            METHOD1. Applying SDL with Arbin Cyclers using Mits Pro 8
          </div>
          <div>
            <div class="frame-3361082">
              <div class="smart-data-logging">Smart Data Logging</div>
            </div>
          </div>
            <div class="frame-3361083">
              <div class="charging-the-battery-to-3-8-v-using-1-a-current-and-log-data-when-v-5-m-v-or-every-5-minutes">
                Charging the battery to 3.8V using 1A current and log data when ∆V
                &gt; 5mV or every 5 minutes.
              </div>
              <img decoding="async" class="image-13997 entered lazyloaded" src="/wp-content/uploads/2024/10/Arbin-SD-Logging-Solution-method-1-i4.png" data-lazy-src="/wp-content/uploads/2024/10/Arbin-SD-Logging-Solution-method-1-i4.png" data-ll-status="loaded" width="846" height="85"><noscript><img decoding="async" class="image-13997" src="/wp-content/uploads/2024/10/Arbin-SD-Logging-Solution-method-1-i4.png"></noscript>
              <div class="figure-5-testing-schedule-for-smart-data-logging-mits-pro-8">
                Figure 5. Testing Schedule for Smart Data Logging (Mits Pro8)
              </div>
          </div>
        </div>
          <div class="frame-1">
            ...
            <div>
              ...
              <div class="frame-3361083">
                ...
                <img decoding="async" class="image-13998 entered lazyloaded" src="/wp-content/uploads/2024/10/Arbin-SD-Logging-Solution-method-1-i5.png" data-lazy-src="/wp-content/uploads/2024/10/Arbin-SD-Logging-Solution-method-1-i5.png" data-ll-status="loaded" width="846" height="163"><noscript><img decoding="async" class="image-13998" src="/wp-content/uploads/2024/10/Arbin-SD-Logging-Solution-method-1-i5.png"></noscript>
                <div class="figure-6-testing-schedule-for-smart-data-logging-mits-pro-x">
                  Figure 6. Testing Schedule for Smart Data Logging (MITS)
                </div>
              </div>
          </div>
