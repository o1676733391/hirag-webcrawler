...
- URL: https://www.arbin.com/why-is-lithium-ion-battery-recycling-still-limited.html

# Content

#  Why is lithium-ion battery recycling still limited?
April 2, 2021
[![](https://www.arbin.com/wp-content/uploads/2021/04/MzAxMjQ1NA-300x225-1.jpeg)](https://spectrum.ieee.org/energywise/energy/environment/simple-energyefficient-recycling-process-for-lithiumion-cathodes)
Creator: UCSD Jacobs School of Engineering – David Baillot 
Copyright: CC 3.0 – Jacobs School of Engineering, UC San Diego
Market analysts predict that 705,000 tons of lithium-ion batteries will reach end-of-life by 2025. With batteries growing to be a staple in a future of clean energy, this number is set to grow exponentially, potentially reaching **[9 million tons per year](https://s3.i-micronews.com/uploads/2020/07/YDR20092_Li-ion_Battery_Recycling_Trends_2020_flyer.pdf)** by 2040. Despite the increasing battery waste, the battery recycling rate is considerably low — it is currently estimated to only be **[5%](https://www.mpoweruk.com/recycling.htm)**.
...
Although recycled materials just are as usable as newly mined ones, the price of raw materials can sometimes be **[cheaper than recycled materials](https://cen.acs.org/materials/energy-storage/time-serious-recycling-lithium/97/i28)****.** Cobalt is one example. If the price of fresh cobalt is cheaper, recyclers would not be able to compete and the recycling business would not be economically viable. The possibility of new chemistries emerging also threatens the recycling business. For instance, if cobalt is fully edged out of batteries, recyclers would have no incentive to extract it from battery waste. If other battery chemistries that use a different combination of materials become more popular than lithium-ion, there would also be less incentive to retrieve materials in discarded batteries.
  * **Complex chemistries**
...
**[Learn more](https://www.arbin.com/request-a-quote/)** about how Arbin helps customers on the forefront of battery research.
