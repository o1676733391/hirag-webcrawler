...
- URL: https://www.arbin.com/battery-testing/rbt4-cell.html
...
##  Highlights
  * Suitable for large scale high current characterization or quality control testing​
  * <100ppm Measurement Precision​
  * 24-Bit Voltage & Current Measurement Resolution​
  * 6V, 10V, or 20V configurations​

  * Reduce Energy Consumption and HVAC load by utilizing efficient regenerative circuitry to return up to 83% of discharge energy back to the grid​
  * 2 Current Ranges per Channel; 3 ranges when in parallel​
  * Parallel any number of channels up to 1600A

##  System Specifications
Battery Testing - Cell
RBT-Cell
Hardware
Number of Channels
48
