...
- URL: https://www.arbin.com/5-criteria-to-assess-battery-materials.html

# Content

#  5 Criteria to Assess Battery Materials
December 21, 2020
![](https://www.arbin.com/wp-content/uploads/2020/12/battery-1392x783-1-300x169-2.jpg)
...
In 2010, a lithium-ion battery pack cost more than USD1000/kwh. This dropped significantly to **[USD156/kwh by 2019](https://arstechnica.com/tech-policy/2020/09/the-story-of-cheaper-batteries-from-smartphones-to-teslas/)** , and is projected to drop below USD100/kwh in the coming years.
The reducing cost of the battery has allowed more and more people to buy into batteries as a permanent energy solution for large applications such as **[electric vehicles](https://www.arbin.com/battery-test-equipment/electric-vehicle-battery-testing.html)** or grid storage, facilitating the shift towards clean energy.
However, certain materials commonly used within lithium-ion batteries contribute to the high cost of the battery. For instance, **[cobalt is pricey](https://www.mining.com/cobalt-nickel-price-rally-lifts-ev-metal-index-to-2020-high/)** and its cost tends to fluctuate due to limited supply and high demand. The case is similar for **[nickel](https://www.ft.com/content/afe946e4-cd5f-11e9-b018-ca4456540ea6)**. As the supply of these metals tend to be concentrated in certain parts of the world — the Democratic Republic of Congo for cobalt, and Indonesia for nickel — their prices would be dependent on the export policies of these countries.

  * **Abundance and sustainability**

The abundance and supply of a material not only affects its price but also long-term sustainability. Some analysts predict that the supply of the rare metals used in current batteries could deteriorate in just a few years. Industry insiders project that there would be a **[shortage of cobalt by 2022](https://asia.nikkei.com/Business/Markets/Commodities/Milestone-reached-in-the-recycle-of-cobalt-from-spent-EV-batteries)**. In order to support the increasing demand for batteries, researchers are searching for alternatives.
One such alternative is sodium. Sodium is the sixth most abundant element on earth — comparatively, lithium is the 25th. This means the sodium is a strong rival to lithium in terms of long-term availability. The sodium-ion battery is **[potentially cheaper and easier to produce](https://www.sciencealert.com/new-sodium-ion-battery-performs-as-well-as-some-commercial-lithium-ion-models)** than its lithium-ion counterpart, though there is still much to improve upon before it becomes a solid contender in terms of energy density.
...
How materials are extracted from the environment and the effect this has should also be taken into account. Lithium mining has been found to cause **[habitat destruction and pollution](https://www.nsenergybusiness.com/features/lithium-ion-battery-environmental-impact/#:~:text=A%20report%20on%20lithium%20by,are%20needed%20to%20process%20lithium.)** , and damages the soil of surrounding agriculture operations.
...
Posts navigation
[← The Role of Batteries in an IoT Future](https://www.arbin.com/the-role-of-batteries-in-an-iot-future.html)
