...
| Safety Interlock Systems | Test chambers are equipped with safety interlock systems—mechanisms designed to automatically stop or prevent testing whenever the chamber door is opened. |
...
| Example | Description |
|------|------|
| IV Channel 5 | If the tested battery is connected to **IV Channel 5**, and the chamber’s door lock is connected to **Aux Digital Input Channel 1**, then you must map **Aux Digital Input Channel 1 → IV Channel 5**. |
...
| Factor | Description |
|------|------|
| Importance of Safety | A door switch interlock may seem minor—but in battery testing, it’s a critical safety component. Whether you’re running a small lab or a full-scale EV battery test rig, installing a simple door switch can protect your team, your equipment, and your results. |

# Related Technologies / Concepts

| Concept | Description |
|------|------|
| Safety Interlock Systems | Mechanisms designed to automatically stop or prevent testing whenever the chamber door is opened. |
